...
imdb = load('E:/VLFEAT/matconvnet/data/charsdb.mat') ;
...
trainOpts.expDir = 'E:/VLFEAT/matconvnet/data/chars-experiment' ;
...
save('E:/VLFEAT/matconvnet/data/chars-experiment/charscnn.mat', '-struct', 'net') ;
...
net = load('E:/VLFEAT/matconvnet/data/chars-experiment/charscnn.mat') ;
%net = load('data/chars-experiment/charscnn-jit.mat') ;

% Load the sentence
im = im2single(imread('E:/VLFEAT/matconvnet/data/sentence-lato.png')) ;
...
trainOpts.continue = true ;
trainOpts.learningRate = 0.001 ;
trainOpts.expDir = 'E:/VLFEAT/matconvnet/data/chars-jit-experiment' ;
...
net.layers(end) = [] ;
net.imageMean = imageMean ;
save('E:/VLFEAT/matconvnet/data/chars-experiment/charscnn-jit.mat', '-struct', 'net') ;
